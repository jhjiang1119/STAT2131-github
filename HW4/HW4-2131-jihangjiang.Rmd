...
```
```{r}
plot(best_subset_credit, scale = "Cp");plot(best_subset_credit,scale = "bic")
```
...
```
```{r}
plot(forward_credit, scale = "Cp");plot(forward_credit,scale = "bic")
```
...
```
```{r}
plot(backward_credit, scale = "Cp");plot(backward_credit,scale = "bic")
```
